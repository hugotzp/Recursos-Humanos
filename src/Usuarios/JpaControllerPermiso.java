 ...
 * @author Edwin Chocoy
 */
public class JpaControllerPermiso implements Serializable {

    public JpaControllerPermiso(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public Permiso permisoExiste(String nombre){
        EntityManager em = getEntityManager();
        TypedQuery<Permiso> query = em.createNamedQuery("permisoExiste",Permiso.class);
        query.setParameter("nombre", nombre);
        List<Permiso> permiso = query.getResultList();
        
        if(permiso.size()>0)
            return permiso.get(0);
        else
            return null;
    }
