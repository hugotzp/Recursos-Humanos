 ...
 * @author Edwin Chocoy
 */
public class JpaControllerPaquete implements Serializable {

    public JpaControllerPaquete(EntityManagerFactory emf) {
        this.emf = emf;
    }
    ...
    public Paquete paqueteExiste(String nombre){
        EntityManager em = getEntityManager();
        TypedQuery<Paquete> query = em.createNamedQuery("paqueteExiste",Paquete.class);
        query.setParameter("nombre", nombre);
        List<Paquete> paquete = query.getResultList();
