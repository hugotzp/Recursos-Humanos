 ...
 * @author Hugo
 */
public class JpaControllerPrestamo implements Serializable {

    public JpaControllerPrestamo(EntityManagerFactory emf) {
        this.emf = emf;
    }
    private EntityManagerFactory emf = null;
    
     public List<Prestamo> findPrestamos(Long id){
        EntityManager em = getEntityManager();
        TypedQuery<Prestamo> query = em.createNamedQuery("PrestamosTrabajador",Prestamo.class);
